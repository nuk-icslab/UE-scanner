...
bool rrc::ue::select_security_algorithms()
{
  ...
  // œall bits equal to 0UE supports no other algorithm than EEA0,
  // œfirst bit128-EEA1,
  // œsecond bit128-EEA2,
  // œthird bit128-EEA3,
  // other bits reserved for future use. Value indicates support and value
  // indicates no support of the algorithm.
